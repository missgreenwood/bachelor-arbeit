...
\normalfont
Wie zu Beginn des Kapitels dargestellt, ist bei der Hinzunahme von Ressourcen auf einem Rechencluster mit einem linearen Anstieg der Ausf"uhrungdauer und ann"ahernd konstanter Ausf"uhrungsdauer zu rechnen. McCalpin schreibt hierzu: 
\begin{quote}
\onehalfspacing
...
\end{quote} 
Nach der Funktionsweise des Benchmarks ist somit auszuschlie\ss en, dass die erh"ohte Ausf"uhrungsdauer f"ur $n>17$ RPi-Knoten einen erw"unschten Effekt darstellt.  
