...
% TODO: Interpretation HPL Messreihe 1
...
%    \hline 
%     \textbf{Angeschaltete RPis:} & \textbf{Aktive RPis:} & \textbf{Performance in GFLOPs:} &\textbf{Ausf"uhrungsdauer in s:}\\ 
%    \hline 
%    20 & 16 & &\\
%    \hline 
%    17 & 16 & &\\
...
%    \hline
%  \end{tabular}
%  \caption{Erzielte Messwerte f"ur HPL, Messreihe 1 und Messreihe 2.}\label{fig:hpl-vgl}
%\end{figure}
%\noindent
%Dabei "uberschreiten die Differenzen in keinem Fall die Gr"o\ss enordnung von %z
%, liegen also innerhalb des Messfehlers (vgl. Kap. \ref{Ergebnisse-HPL}). Somit l"asst sich schlussfolgern, dass das Herunterfahren nicht mehr aktiver RPi-Knoten keine signifikanten Auswirkungen auf Performance und Ausf"uhrungsdauer von HPL auf dem Bramble hat. Das Skalierungsverhalten kann somit f"ur beide Messreihen als gleich bezeichnet werden. 
