...
Hier sind zwei Ursachen denkbar: Die Systemzeit und vor allem das Netzwerk. 
...
% - Ethernet/Netzwerk
% - Bleiben Bandbreiten gleich? (checken durch Runterrechnen, d.h. Performance * Ausführungszeit = MB/s * s)
\end{enumerate}
