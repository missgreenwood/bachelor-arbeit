...
Um den xls-Export nutzen zu k"onnen, muss die grafische Aufzeichnung gestartet werden. Die aktuell gemessenen Werte f"ur die Leistung in Watt werden als Kurve angezeigt, was sich zur "Uberwachung der Messung als hilfreich erwiesen hat. 
% Export der Messwerte
	\textbf{\item Export der Messwerte.}
% Zur weiteren Verarbeitung werden die w"ahrend der Zeitdauer der Programmausf"uhrung ermittelten Werte exportiert.
	\textbf{\item Herunterladen der Datei.}\\ 
% Zur weiteren Verarbeitung wird die Datei von der Windows-Maschine heruntergeladen.
