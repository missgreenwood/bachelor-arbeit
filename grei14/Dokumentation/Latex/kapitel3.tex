...
Die wichtigsten Ausgabeparameter sind Ausf"uhrungsrate in GFLOPs (\texttt{Gflops}) und Ausf"uhrungsdauer (\texttt{Time}) in Sekunden. F"ur jede Ausf"uhrung von HPLinpack werden 864 Tests durchgef"uhrt, d.h. 864 Messwerte f"ur Ausf"uhrungsrate und Ausf"uhrungsdauer erzeugt. \texttt{Gflops} wird auf 8, \texttt{Time} auf 2 Nachkommastellen genau angegeben. 
