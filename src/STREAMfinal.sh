...
# Run STREAM on 16-1 RPi-Nodes, run again and shutdown RPi-Node n afterwards      
...
# loop over n RPis 
for host in for host in pi20 pi18 pi17 pi16 pi15 pi13 pi11 pi10 pi09 pi08 pi07 pi06 pi05 pi04 pi02 pi01 
do
    n=${host/pi/}
    n=$(echo $n|sed 's/^0*//')
    echo "Number of active RPis: $n"
