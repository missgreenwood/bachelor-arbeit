...
# write to plot files 
sed -e 's/$/ 16/' plot1aa > ../sources/hplplot1.txt
sed -e 's/$/ 15/' plot1ab >> ../sources/hplplot1.txt
sed -e 's/$/ 14/' plot1ac >> ../sources/hplplot1.txt
sed -e 's/$/ 13/' plot1ad >> ../sources/hplplot1.txt
sed -e 's/$/ 12/' plot1ae >> ../sources/hplplot1.txt
sed -e 's/$/ 11/' plot1af >> ../sources/hplplot1.txt
sed -e 's/$/ 10/' plot1ag >> ../sources/hplplot1.txt
sed -e 's/$/ 9/' plot1ah >> ../sources/hplplot1.txt
sed -e 's/$/ 8/' plot1ai >> ../sources/hplplot1.txt
sed -e 's/$/ 7/' plot1aj >> ../sources/hplplot1.txt
sed -e 's/$/ 6/' plot1ak >> ../sources/hplplot1.txt
sed -e 's/$/ 5/' plot1al >> ../sources/hplplot1.txt
sed -e 's/$/ 4/' plot1am >> ../sources/hplplot1.txt

sed -e 's/$/ 16/' plot2aa > ../sources/hplplot2.txt
sed -e 's/$/ 15/' plot2ab >> ../sources/hplplot2.txt
sed -e 's/$/ 14/' plot2ac >> ../sources/hplplot2.txt
sed -e 's/$/ 13/' plot2ad >> ../sources/hplplot2.txt
sed -e 's/$/ 12/' plot2ae >> ../sources/hplplot2.txt
sed -e 's/$/ 11/' plot2af >> ../sources/hplplot2.txt
sed -e 's/$/ 10/' plot2ag >> ../sources/hplplot2.txt
sed -e 's/$/ 9/' plot2ah >> ../sources/hplplot2.txt
sed -e 's/$/ 8/' plot2ai >> ../sources/hplplot2.txt
sed -e 's/$/ 7/' plot2aj >> ../sources/hplplot2.txt
sed -e 's/$/ 6/' plot2ak >> ../sources/hplplot2.txt
sed -e 's/$/ 5/' plot2al >> ../sources/hplplot2.txt
sed -e 's/$/ 4/' plot2am >> ../sources/hplplot2.txt
