...
# Run hplinpack on 17-4 RPi-Nodes, run again and shutdown RPi-Node n afterwards                                                                                             
...
for host in pi20 pi18 pi17 pi16 pi15 pi13 pi11 pi10 pi09 pi08 pi07 pi06 pi05 pi04
do
    n=${host/pi/}
    n=$(echo $n|sed 's/^0*//')
    n=$(($n - 4))
...
# log number of active RPis/powered RPis to results/hpl-2.1_`date +%y%m%d`.txt                                                                                                      
	echo "Active RPis: "$n"/Powered RPis: 16" >> results/hpl-2.1_`date +%y%m%d`.txt
...
# start benchmark on n RPis, log to results/hpl-2.1_`date +%y%m%d`.txt                                                                                                      
	...
	echo "HPlinpack finished on $n RPis active, 16 RPis powered"
done
...
# log number of active RPis/powered RPis to results/hpl-2.1_`date +%y%m%d`.txt                                                                                              
	echo "Active RPis: "$n"/Powered RPis: 16" >> results/hpl-2.1_shutdown`date +%y%m%d`.txt
