...
# Run HPLinpack on 4 RPi-Nodes, 20 RPi-Nodes powered
...
# create output files                                                                 
touch results/hplMessung1`date +%y%m%d`.txt results/hplMessung1_shutdown`date +%y%m%d`.txt
...
# start benchmark on n RPis, log to results/hplMessung1`date +%y%m%d`.txt                        
...
# Run HPLinpack on 4 RPi-Nodes, 5 RPi-Nodes powered
# Working directory: /srv/benchmarks/bin/hpl-2.1/messung1
# Input file: /srv/benchmarks/bin/hpl-2.1/messung1/HPL.dat
# Machinefile: /srv/libraries/etc/mpich-3.0.4-shared/machinefile_lastest
# Executable: /srv/benchmarks/bin/hpl-2.1/messung1/xhpl
